...
export function Watchlist() {
  ...
  if (isLoading) {
    return (
      <div className="text-crypto-muted animate-pulse">
        Loading watchlist...
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-[13px] font-bold text-white mb-1">
          Your Portfolio
        </h1>
        <p className="text-[11px] font-semibold text-[#808A9D]">
          Manage your favorite cryptocurrency assets.
        </p>
      </div>
      ...
      {filteredCoins.length === 0 ? (
        <div className="bg-[#151A27] border border-[#1E2532] rounded-xl p-12 text-center flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-[#5A657A] font-bold text-[13px]">
