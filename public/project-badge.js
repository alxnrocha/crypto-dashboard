(function () {
  const projectName = 'CryptoFlow Terminal';
  const projectUrl = 'https://alxnrocha.github.io/crypto-dashboard/';
  const description = 'Dashboard AnalÃ­tico de Criptomoedas em Tempo Real';
